...
CORS(app, resources={r"/*": {"origins": "https://fuzzy-umbrella-xj9qj756gvpf6rx5-3000.app.github.dev"}})
...
@cross_origin(origin='https://fuzzy-umbrella-xj9qj756gvpf6rx5-3000.app.github.dev', headers=['Content-Type', 'Authorization'])
def admin_user_route():
    ...
    response.headers.add('Access-Control-Allow-Origin', 'https://fuzzy-umbrella-xj9qj756gvpf6rx5-3000.app.github.dev')
