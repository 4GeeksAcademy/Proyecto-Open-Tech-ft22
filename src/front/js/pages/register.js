...
export const Register = () => {
    ...
    return (
        <div className="trolola pseudo-navbar-register" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>

            <h1 style={{ background: '-webkit-linear-gradient(left, blue, white)', WebkitBackgroundClip: 'text', color: 'transparent', paddingTop: '20px' }}>
                {t('Registration')}
            </h1>
            <form onSubmit={handleSubmit} className='trolole mx-auto p-3 border-1' style={{ boxShadow: '0 5px 9px rgba(0, 0, 0, 0.5)', marginTop: '20px' }}>
