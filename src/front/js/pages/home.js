			...
			<div className="d-flex justify-content-around flex-wrap mb-5 mt-5">
				<div className="card custom-card" style={{ width: '19rem', margin: '10px 5px' }}>
					...
					<div className="card-body">
						<p className="card-text text-justify">{t('Providing transparency in IT salaries empowers professionals to make informed decisions about their career paths. Users can compare their salaries with industry standards, helping them negotiate better compensation packages and make strategic career choices.')}</p>
					</div>
				</div>
				...
				<div className="card custom-card" style={{ width: '19rem', margin: '10px 5px' }}>
					...
					<div className="card-body">
						<p className="card-text">{t('The platform allows users to benchmark their salaries against others in the same industry or role. This valuable data enables individuals to gauge their position in the job market, understand salary trends, and identify opportunities for career growth.')}</p>
					</div>
				</div>
				...
				<div className="card custom-card" style={{ width: '19rem', margin: '10px 5px' }}>
					...
					<div className="card-body">
						<p className="card-text">{t('By openly sharing salary information, the platform contributes to fostering fair compensation practices. It helps highlight discrepancies and encourages employers to maintain competitive salary structures, creating a more equitable and just work environment for IT professionals.')}</p>
					</div>
				</div>
